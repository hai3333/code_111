...
public class test3and4 {
   // private String intFilePatch;
    private   static String intFilePatch;
    private static  String outFilePatch;

    public test3and4() {
    }

    public test3and4(String intFilePatch, String outFilePatch) {
        this.intFilePatch = intFilePatch;
        this.outFilePatch = outFilePatch;
    }

    public String getIntFilePatch() {
        return intFilePatch;
    }

    public void setIntFilePatch(String intFilePatch) {
        this.intFilePatch = intFilePatch;
    }

    public String getOutFilePatch() {
        return outFilePatch;
    }

    public void setOutFilePatch(String outFilePatch) {
        this.outFilePatch = outFilePatch;
    }
    ...
    public String toString() {
        return "test3and4{" +
                "intFilePatch='" + intFilePatch + '\'' +
                ", outFilePatch='" + outFilePatch + '\'' +
                '}';
    }
